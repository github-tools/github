...
class Gist extends Requestable {
   ...
   /**
    * List the authenticated user's gists. If not logged in, all anonymous gists.
    * @see https://developer.github.com/v3/issues/#list-a-users-gists
    * @param {Object} options - filtering options
    * @param {Requestable.callback} [cb] - will receive the array of gists
    * @return {Promise} - the promise for the http request
    */
   listGists(options, cb) {
      return this._requestAllPages(`/gists`, options, cb);
   }
