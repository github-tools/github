...
class Repository extends Requestable {
   ...
   constructor(fullname, auth, apiBase) {
      super(auth, apiBase);
      this.__repoPath = `/repos/${fullname}`;
      this.__currentTree = {
         branch: null,
         sha: null
      };
    ...
    */
   getRef(ref, cb) {
      return this._request('GET', `${this.__repoPath}/git/refs/${ref}`, null, cb);
   }
   ...
   createRef(options, cb) {
      return this._request('POST', `${this.__repoPath}/git/refs`, options, cb);
   }
    ...
    */
   deleteRef(ref, cb) {
      return this._request('DELETE', `${this.__repoPath}/git/refs/${ref}`, null, cb);
   }
    ...
    */
   deleteRepo(cb) {
      return this._request('DELETE', this.__repoPath, null, cb);
   }
    ...
    */
   listTags(cb) {
      return this._request('GET', `${this.__repoPath}/tags`, null, cb);
   }
   ...
   listPulls(options, cb) {
      options = options || {};
      return this._request('GET', `${this.__repoPath}/pulls`, options, cb);
   }
    ...
    */
   getPull(number, cb) {
      return this._request('GET', `${this.__repoPath}/pulls/${number}`, null, cb);
   }
   ...
   compare(base, head, cb) {
      return this._request('GET', `${this.__repoPath}/compare/${base}...${head}`, null, cb);
   }
    ...
    */
   listBranches(cb) {
      return this._request('GET', `${this.__repoPath}/branches`, null, cb);
   }
    ...
    */
   getBlob(sha, cb) {
      return this._request('GET', `${this.__repoPath}/git/blobs/${sha}`, null, cb, 'raw');
   }

   /**
    * Get a commit from the repository
    * @see https://developer.github.com/v3/repos/commits/#get-a-single-commit
    * @param {string} branch - unused
    * @param {string} sha - the sha for the commit to fetch
    * @param {Requestable.callback} cb - will receive the commit data
    * @return {Promise} - the promise for the http request
    */
   getCommit(branch, sha, cb) {
      return this._request('GET', `${this.__repoPath}/git/commits/${sha}`, null, cb);
   }
   ...
   getSha(branch, path, cb) {
      ...
      return this._request('GET', `${this.__repoPath}/contents/${path}${branch}`, null, cb);
   }
    ...
    */
   getStatuses(sha, cb) {
      return this._request('GET', `${this.__repoPath}/commits/${sha}/statuses`, null, cb);
   }
    ...
    */
   getTree(treeSHA, cb) {
      return this._request('GET', `${this.__repoPath}/git/trees/${treeSHA}`, null, cb);
   }
   ...
   postBlob(content, cb) {
      ...
      return this._request('POST', this.__repoPath + '/git/blobs', postBody, cb);
   }
   ...
   updateTree(baseTreeSHA, path, blobSHA, cb) {
      ...
      return this._request('POST', `${this.__repoPath}/git/trees`, newTree, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   postTree(tree, baseSHA, cb) {
      return this._request('POST', `${this.__repoPath}/git/trees`, {tree, base_tree: baseSHA}, cb); // jscs:ignore
   }
   ...
   commit(parent, tree, message, cb) {
      ...
      return this._request('POST', `${this.__repoPath}/git/commits`, data, cb)
         .then((response) => {
    ...
    */
   show(cb) {
      return this._request('GET', this.__repoPath, null, cb);
   }
   ...
   contributors(cb) {
      ...
      return this._request('GET', `${this.__repoPath}/stats/contributors`, null, cb);
   }

   /**
    * List the users who are collaborators on the repository
    * @see https://developer.github.com/v3/repos/collaborators/#list-collaborators
    * @param {Function} cb - will receive the list of collaborators
    * @return {Promise} - the promise for the http request {[type]} [description]
    */
   collaborators(cb) {
      return this._request('GET', `${this.__repoPath}/collaborators`, null, cb);
   }
   ...
   isCollaborator(username, cb) {
      return this._request('GET', `${this.__repoPath}/collaborators/${username}`, null, cb);
   }
   ...
   contents(ref, path, cb) {
      ...
      return this._request('GET', `${this.__repoPath}/contents/${path}`, {ref}, cb);
   }
    ...
    */
   fork(cb) {
      return this._request('POST', `${this.__repoPath}/forks`, null, cb);
   }
    ...
    */
   listForks(cb) {
      return this._request('GET', `${this.__repoPath}/forks`, null, cb);
   }
   ...
   createPullRequest(options, cb) {
      return this._request('POST', `${this.__repoPath}/pulls`, options, cb);
   }
    ...
    */
   listHooks(cb) {
      return this._request('GET', `${this.__repoPath}/hooks`, null, cb);
   }
    ...
    */
   getHook(id, cb) {
      return this._request('GET', `${this.__repoPath}/hooks/${id}`, null, cb);
   }
   ...
   createHook(options, cb) {
      return this._request('POST', `${this.__repoPath}/hooks`, options, cb);
   }
   ...
   editHook(id, options, cb) {
      return this._request('PATCH', `${this.__repoPath}/hooks/${id}`, options, cb);
   }
   ...
   /**
    * Get the raw contents of a file in a branch
    * @see https://developer.github.com/v3/repos/contents/#get-contents
    * @param {string} branch - the name of the branch to read from, or the default branch if not specified
    * @param {string} path - the path to read from
    * @param {Function} cb - will receive the raw file contents
    * @return {Promise} - the promise for the http request {[type]} [description]
    */
   read(branch, path, cb) {
      path = path ? encodeURI(path) : '';
      return this._request('GET', `${this.__repoPath}/contents/${path}`, {ref: branch}, cb, 'raw');
   }
   ...
   remove(branch, path, cb) {
      this.getSha(branch, path)
         .then((response) => {
            ...
            return this._request('DELETE', `${this.__repoPath}/contents/${path}`, deleteCommit, cb);
         });
   }
    ...
    * @param {Object} [options.commit] - the committer
   ...
   write(branch, path, content, message, options, cb) {
      ...
      return this.getSha(branch, filePath)
         .then((response) => {
            ...
            return this._request('PUT', `${this.__repoPath}/contents/${filePath}`, commit, cb);
         }, () => {
            return this._request('PUT', `${this.__repoPath}/contents/${filePath}`, commit, cb);
         });
   }
    ...
    * @param {Object} [options] - options to filter by
   ...
   getCommits(options, cb) {
      ...
      return this._request('GET', `${this.__repoPath}/commits`, options, cb);
   }
   ...
   isStarred(owner, repository, cb) {
      return this._request204or404('/user/starred/' + owner + '/' + repository, null, cb);
   }
   ...
   star(owner, repository, cb) {
      return this._request('PUT', '/user/starred/' + owner + '/' + repository, null, cb);
   }
   ...
   unstar(owner, repository, cb) {
      return this._request('DELETE', '/user/starred/' + owner + '/' + repository, null, cb);
   }
   ...
   createRelease(options, cb) {
      return this._request('POST', this.__repoPath + '/releases', options, cb);
   }
   ...
   editRelease(id, options, cb) {
      return this._request('PATCH', this.__repoPath + '/releases/' + id, options, cb);
   }
    ...
    */
   getRelease(id, cb) {
      return this._request('GET', this.__repoPath + '/releases/' + id, null, cb);
   }
    ...
    */
   deleteRelease(id, cb) {
      return this._request('DELETE', this.__repoPath + '/releases/' + id, null, cb);
   }
}
