...
class Repository extends Requestable {
    ...
    * @return {Promise} - the promise for the http request
    */
   getProject(number, cb) {
      return this._request('GET', `/repos/${this.__fullname}/projects/${number}`, null, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   updateProject(number, options, cb) {
      return this._request('PATCH', `/repos/${this.__fullname}/projects/${number}`, options, cb);
   }

   /**
    * Delete a project
    * @see https://developer.github.com/v3/repos/projects/#delete-a-project
    * @param {string} number - the project to be deleted
    * @param {Requestable.callback} cb - will receive true if the operation is successful
    * @return {Promise} - the promise for the http request
    */
   deleteProject(number, cb) {
      return this._request('DELETE', `/repos/${this.__fullname}/projects/${number}`, null, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   listProjectColumns(number, cb) {
      return this._request('GET', `/repos/${this.__fullname}/projects/${number}/columns`, null, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   createProjectColumn(number, options, cb) {
      return this._request('POST', `/repos/${this.__fullname}/projects/${number}/columns`, options, cb);
   }
   ...
   moveProjectColumn(id, position, cb) {
      return this._request(
         'POST',
         `/repos/${this.__fullname}/projects/columns/${id}/moves`,
         {"position": position},
         cb
      );
   }
   ...
   * @return {Promise} - the promise for the http request
   */
   moveProjectCard(id, position, colId, cb) {
      return this._request(
         'POST',
         `/repos/${this.__fullname}/projects/columns/${id}/moves`,
