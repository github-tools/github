...
class Repository extends Requestable {
    ...
    */
   getProject(id, cb) {
      return this._request('GET', `/repos/${this.__fullname}/projects/${id}`, null, cb)
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   updateProject(id, options, cb) {
      return this._request('PATCH', `/repos/${this.__fullname}/projects/${id}`, options, cb);
   }

   /**
    * Delete a project
    * @see https://developer.github.com/v3/repos/projects/#delete-a-project
    * @param {string} id - the project to be deleted
    * @param {Requestable.callback} cb - will receive true if the operation is successful
    * @return {Promise} - the promise for the http request
    */
   deleteProject(id, cb) {
      return this._request('DELETE', `/repos/${this.__fullname}/projects/${id}`, null, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   listProjectColumns(id, cb) {
      return this._request('GET', `/repos/${this.__fullname}/projects/${id}/columns`, null, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   getProjectColumn(id, cb) {
      return this._request('GET', `/repos/${this.__fullname}/projects/columns/${id}`, null, cb)
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   createProjectColumn(id, options, cb) {
      return this._request('POST', `/repos/${this.__fullname}/projects/${id}/columns`, options, cb);
   }
    ...
    * @return {Promise} - the promise for the http request
    */
   updateProjectColumn(id, options, cb) {
      return this._request('PATCH', `/repos/${this.__fullname}/projects/columns/${id}`, options, cb);
   }

   /**
    * Delete a column
    * @see https://developer.github.com/v3/repos/projects/#delete-a-column
    * @param {string} id - the column to be deleted
    * @param {Requestable.callback} cb - will receive true if the operation is successful
    * @return {Promise} - the promise for the http request
    */
   deleteProjectColumn(id, cb) {
      return this._request('DELETE', `/repos/${this.__fullname}/projects/columns/${id}`, null, cb);
   }

   /**
    * Move a column
    * @see https://developer.github.com/v3/repos/projects/#move-a-column
    * @param {string} id - the column to be moved
    * @param {string} position - can be one of first, last, or after:<column-id>, where <column-id> is the id value of a column in the same project.
    * @param {Requestable.callback} cb - will receive true if the operation is successful
    * @return {Promise} - the promise for the http request
    */
   moveProjectColumn(id, position, cb) {
      return this._request('POST', `/repos/${this.__fullname}/projects/columns/${id}/moves`, {"position": position}, cb);
   }
   ...
   * @return {Promise} - the promise for the http request
   */
   listProjectCards(id, cb) {
      return this._request('GET', `/repos/${this.__fullname}/projects/columns/${id}/cards`, null, cb);
   }
   ...
   * @return {Promise} - the promise for the http request
   */
   getProjectCard(id, cb) {
      return this._request('GET', `/repos/${this.__fullname}/projects/columns/cards/${id}`, null, cb)
   }
   ...
   * @return {Promise} - the promise for the http request
   */
   createProjectCard(id, options, cb) {
      return this._request('POST', `/repos/${this.__fullname}/projects/columns/${id}/cards`, options, cb);
   }
   ...
   * @return {Promise} - the promise for the http request
   */
   updateProjectCard(id, options, cb) {
      return this._request('PATCH', `/repos/${this.__fullname}/projects/columns/cards/${id}`, options, cb);
   }

   /**
   * Delete a card
   * @see https://developer.github.com/v3/repos/projects/#delete-a-project-card
   * @param {string} id - the card to be deleted
   * @param {Requestable.callback} cb - will receive true if the operation is successful
   * @return {Promise} - the promise for the http request
   */
   deleteProjectCard(id, cb) {
      return this._request('DELETE', `/repos/${this.__fullname}/projects/columns/cards/${id}`, null, cb);
   }

   /**
   * Move a card
   * @see https://developer.github.com/v3/repos/projects/#move-a-project-card
   * @param {string} id - the card to be moved
   * @param {string} position - can be one of top, bottom, or after:<card-id>, where <card-id> is the id value of a card in the same project.
   * @param {string} column_id - the id value of a column in the same project.
   * @param {Requestable.callback} cb - will receive true if the operation is successful
   * @return {Promise} - the promise for the http request
   */
   moveProjectCard(id, position, col_id, cb) {
      return this._request('POST', `/repos/${this.__fullname}/projects/columns/${id}/moves`, {"position": position, "column_id": column_id}, cb);
   }
