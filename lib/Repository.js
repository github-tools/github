...
class Repository extends Requestable {
    ...
    * @return {Promise} - the promise for the http request
    */
   listBranches(options, cb) {
      options = options || {};
      if (typeof options === 'function') {
         cb = options;
         options = {};
      }
      return this._request('GET', `/repos/${this.__fullname}/branches`, options, cb);
   }
   ...
   /**
    * Get a branch protecion
    * @see https://developer.github.com/v3/repos/branches/#get-branch-protection
    * @param {string} branch - the name of the branch to fetch
    * @param {Requestable.callback} cb - will receive the branch from the API
    * @returns {Promise} - the promise for the http request
    */
   getBranchProtection(branch, cb) {
      return this._request('GET', `/repos/${this.__fullname}/branches/${branch}/protection`, null, cb);
   }
